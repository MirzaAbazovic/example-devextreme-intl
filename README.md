...
## Instalacija
Instalirati https://www.npmjs.com/package/devextreme-intl
```Shell
...
U app.mopdule.ts importovati potrebne module i sa njima importovati poruke i setovati  
...
IE podrzava i bs-Latn-BA

Primjer engleskog json-a
```
{
    "en": {
        "Yes": "Yes",
